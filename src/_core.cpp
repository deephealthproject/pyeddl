...
void bind_eddl_tensor_tensor(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Tensor file:eddl/tensor/tensor.h line:65
		...
		cl.def("normalize", (class Tensor * (Tensor::*)(float, float)) &Tensor::normalize, "Inplace element-wise normalization of values in a given range.\n   \n\n The lower bound of the new range.\n   \n\n The upper bound of the new range.\n   \n\n A tensor with the result.\n\nC++: Tensor::normalize(float, float) --> class Tensor *", pybind11::return_value_policy::automatic, pybind11::arg("min"), pybind11::arg("max"));
		...
		cl.def_static("static_normalize", (void (*)(class Tensor *, class Tensor *, float, float)) &Tensor::normalize, "Inplace element-wise normalization of values in a given range.\n   \n\n The tensor where the operation is applied.\n   \n\n The output tensor.\n   \n\n The lower bound of the new range\n   \n\n The upper bound of the new range\n\nC++: Tensor::normalize(class Tensor *, class Tensor *, float, float) --> void", pybind11::arg("A"), pybind11::arg("B"), pybind11::arg("min"), pybind11::arg("max"));
		...
		cl.def_static("flip", [](class Tensor * a0, class Tensor * a1) -> void { return Tensor::flip(a0, a1); }, "", pybind11::arg("A"), pybind11::arg("B"));
		cl.def_static("flip", (void (*)(class Tensor *, class Tensor *, int)) &Tensor::flip, "Flip the tensor.\n   \n\n Input tensor.\n   \n\n Output tensor.\n   \n\n The axis used to flip the tensor.\n\nC++: Tensor::flip(class Tensor *, class Tensor *, int) --> void", pybind11::arg("A"), pybind11::arg("B"), pybind11::arg("axis"));
...
void bind_eddl_apis_eddl(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// eddl::set_mode(class Net *, int) file:eddl/apis/eddl.h line:507
	...
	// eddl::backward(class Net *) file:eddl/apis/eddl.h line:567
	...
	// eddl::backward(class NetLoss *) file:eddl/apis/eddl.h line:574
	...
	// eddl::clamp(class Net *, float, float) file:eddl/apis/eddl.h line:602
	...
	// eddl::compute_loss(class NetLoss *) file:eddl/apis/eddl.h line:611
	...
	// eddl::compute_metric(class NetLoss *) file:eddl/apis/eddl.h line:618
	...
	// eddl::set_trainable(class Layer *, bool) file:eddl/apis/eddl.h line:1652
	...
	// eddl::getOutput(class Layer *) file:eddl/apis/eddl.h line:1656
	...
	// eddl::getDelta(class Layer *) file:eddl/apis/eddl.h line:1657
	...
	// eddl::getParam(class Layer *, int) file:eddl/apis/eddl.h line:1658
	...
	// eddl::getGradient(class Layer *, int) file:eddl/apis/eddl.h line:1659
	...
	// eddl::copyOutput(class Layer *, class Layer *) file:eddl/apis/eddl.h line:1662
	...
	// eddl::copyDelta(class Layer *, class Layer *) file:eddl/apis/eddl.h line:1663
	...
	// eddl::copyParam(class Layer *, class Layer *, int) file:eddl/apis/eddl.h line:1664
	...
	// eddl::download_cifar10() file:eddl/apis/eddl.h line:1803
	...
	// eddl::download_drive() file:eddl/apis/eddl.h line:1811
	...
	// eddl::download_imdb_2000() file:eddl/apis/eddl.h line:1820
